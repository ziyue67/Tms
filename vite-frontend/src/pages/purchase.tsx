...
export default function PurchasePage() {
  const [plans, setPlans] = useState<any[]>([]); const [providers, setProviders] = useState<any[]>([]); const [provider, setProvider] = useState(""); const [order, setOrder] = useState<any>(null); const [checkout, setCheckout] = useState<any>(null); const [busy, setBusy] = useState<string | null>(null);

...
export default function SubscriptionPage() {
  ...
  return <div className="p-4 space-y-4 max-w-5xl"><div><h1 className="text-xl font-bold">套餐中心</h1><p className="text-sm text-default-500">查看账号级流量、到期时间和转发数量限制</p></div>
    ...
    <Card><CardHeader><h2 className="font-semibold">兑换码</h2></CardHeader><CardBody><div className="flex gap-2 max-w-xl"><Input value={code} onChange={e => setCode(e.target.value)} placeholder="粘贴完整兑换码" /><Button color="primary" onClick={redeem} isDisabled={!code}>兑换</Button></div></CardBody></Card>

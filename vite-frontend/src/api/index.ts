...
export const deleteRedeemCode = (id: string) => Network.delete(`/admin/subscription/redeem-codes/${id}`);
...
export const deleteCurrentAccount = () => Network.delete("/user/account");
